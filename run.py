...
#             interpreter=interpreter, browser=browser, headers=headers
#         )
#         response = scraper.get("https://jurnal.ar-raniry.ac.id/index.php/samarah")
...
res= client.get("https://jurnal.ar-raniry.ac.id/index.php/samarah")
